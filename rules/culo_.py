...
class Game:
    def __init__(self,gamezone,actions):
        ...
        self.down_func={
            ...
            pygame.K_z      :   ["clear_selection","global"], \
            pygame.K_t      :   ["throw_cards","global"], \
            pygame.K_RETURN :   ["throw_cards","global"], \
            pygame.K_e      :   ["end_turn()","global"], \
            
            pygame.K_s      :   ["sort,points","global"], \
            
            pygame.K_d      :   ["draw_a_card","global"], \
            pygame.K_p      :   ["pass_turn","global"], \
