...
rules.down_func= keys {
    K_DOWN   =  list {"pygame.display.toggle_fullscreen()", "local"} ,
    K_ESCAPE =  list {"self.exit()", "local"}, 
    K_F5     =  list {"self.show()", "local"}, 
    K_UP     =  list {"self.showalt()", "local"}, 
    K_z      =  list {"self.clear_selection", "global"}, 
    K_t      =  list {"self.throw_cards", "global"}, 
    K_RETURN =  list {"self.throw_cards", "global"}, 
    K_e      =  list {"self.end_turn()", "global"}, 
    K_s      =  list {"self.sort('points')", "local"}, 
    K_d      =  list {"self.draw_a_card", "global"}, 
    K_p      =  list {"self.pass_turn", "global"}, 
    K_1      =  game.prueba1, 
    K_2      =  game.prueba2, 
    K_F1     =  game.F1, 
    K_F2     =  game.F2, 
